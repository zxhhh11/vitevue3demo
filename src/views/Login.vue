  ...
  <div class="login-bg">
    ...
    <div class="con pos-rel rad20 clearfix">
      ...
      <el-form ref="ruleFormRef" :model="ruleForm" :rules="rules" class="demo-ruleForm" :size="formSize" status-icon>
        ...
        <el-form-item>
          <el-col :span="12">
            <el-button @click="changepwdFun" type="danger" text link>修改密码</el-button>
          </el-col>
          <el-col :span="6">
            <el-button color="#b50029" type="primary" @click="submitForm(ruleFormRef)" round>登录</el-button>
          </el-col>
          <el-col :span="6">
    ...
    <BaseModal :dialogVisiable="changepwd" @hide-dialog="hideDialog" title="修改密码" cancelText="关闭" :hasConfirm="false"
      :showFooter="false" width="40%">
      <el-form ref="changePwdRef" :model="changePwdForm" :rules="pwdRules" label-position="right" label-width="120px"
        class="change-pwd" :size="formSize" status-icon>
        ...
        <el-form-item>
          <el-col :span="6">
            <el-button color="#b50029" type="primary" @click="submitPwdForm(changePwdRef)" round>密码修改</el-button>
          </el-col>
          <el-col :span="6">
