<template>
  <div class="my-service">
    <el-tabs type="border-card">
      <el-tab-pane>
        ...
        <div v-if="queryBox">
          ...
          <div class="tips"> 例如选择的'开始日期'为2011-01-01 ,'结束日期'为2011-01-31,系统将展示 2011-01-01 00:00:00到2011-01-31
            23:59:59之间的符合条件记录</div>
          <el-descriptions :column="2" border>
            <el-descriptions-item label="开始日期" label-align="right" align="left">
              <el-date-picker v-model="startDay" style="width:40%" type="date" placeholder="Pick a day" />
            </el-descriptions-item>
            <el-descriptions-item label="截至日期" label-align="right" align="left">
              <el-date-picker v-model="endDay" style="width:40%" type="date" placeholder="Pick a day" />
            </el-descriptions-item>
        ...
        <div v-else class="print-div" id="printTable">
          <BaseTable :tableData="tranLists" :total="tranLists.length" :currentPage="currentPage" :hasPagination="true"
            :handleClick="handleClick" :isMutiSelect="false" @handleCurrent="handleCurrent"
    ...
    <BaseModal :dialogVisiable="printModalVisiable" @hide-dialog="closePrintModal" @submit-handle="printFun"
      cancelText="关闭" confirmText="点击打印" width="80%">
      <div id="customTable">
