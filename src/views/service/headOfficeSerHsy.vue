  ...
  <div>
    <el-tabs type="border-card">
      <el-tab-pane>
        ...
        <div>
          <BaseTable :tableData="sessionLists" :total="sessionLists.length" :currentPage="currentPage"
    ...
    <BaseModal :dialogVisiable="tradListVisiable" @hide-dialog="hideDialog" title="总行端(400交易列表)" cancelText="关闭"
      :hasConfirm="false" width="60%">
      <!-- 第一种list 渲染方式 list 和data 分别定义 支持插槽 支持content 加标签 但是可能不支持太过复杂的list  -->
      <BaseTable :tableData="tradLists" :total="tradLists.length" :currentPage="tradCurrentPage" :hasPagination="true"
        :handleClick="handleClick" :isMutiSelect="false" @handleCurrent="handleCurrent" :newColumns="tradColumns">
      </BaseTable>
