<template>
  <div>
    <el-tabs v-model="editableTabsVal" type="card" class="demo-tabs right-tabs">
      <!--  tab组件分别渲染 -->
      ...
      <!--  tab组件动态渲染 -->
      <el-tab-pane v-for="item in editableTabs" :key="item.name" :label="(item.title as string)" :name="item.name"
